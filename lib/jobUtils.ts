...
export function normalizeJob(raw: Record<string, unknown>, applicationStatus?: string): StudentJob {
  ...
  return {
    ...
    remote_work: raw.remote_work != null ? Boolean(raw.remote_work) : null,
    travel_required: raw.travel_required != null ? Boolean(raw.travel_required) : null,
    mode_of_work: raw.mode_of_work ? String(raw.mode_of_work) : null,
    education_level: raw.education_level ? String(raw.education_level) : null,
    education_degree: raw.education_degree ? String(raw.education_degree) : null,
    education_branch: raw.education_branch ? String(raw.education_branch) : null,
    number_of_openings: raw.number_of_openings != null ? Number(raw.number_of_openings) : null,
    perks_and_benefits: raw.perks_and_benefits ? String(raw.perks_and_benefits) : null,
    eligibility_criteria: raw.eligibility_criteria ? String(raw.eligibility_criteria) : null,
    service_agreement_details: raw.service_agreement_details
      ? String(raw.service_agreement_details)
      : null,
    expiration_date: raw.expiration_date ? String(raw.expiration_date) : null,
    ctc_with_probation: raw.ctc_with_probation ? String(raw.ctc_with_probation) : null,
    ctc_after_probation: raw.ctc_after_probation ? String(raw.ctc_after_probation) : null,
    selection_process: raw.selection_process ? String(raw.selection_process) : null,
    campus_drive_date: raw.campus_drive_date ? String(raw.campus_drive_date) : null,
    corporate_id: raw.corporate_id ? String(raw.corporate_id) : null,
    company_logo: raw.company_logo ? String(raw.company_logo) : null,
    company_website: raw.company_website ? String(raw.company_website) : null,
    company_address: raw.company_address ? String(raw.company_address) : null,
    company_size: raw.company_size ? String(raw.company_size) : null,
    company_type: raw.company_type ? String(raw.company_type) : null,
    company_founded: raw.company_founded != null ? Number(raw.company_founded) : null,
    company_description: raw.company_description ? String(raw.company_description) : null,
    contact_person: raw.contact_person ? String(raw.contact_person) : null,
    contact_designation: raw.contact_designation ? String(raw.contact_designation) : null,
  };
}
